...
> & {
  ...
  /** Persist one Workspace group's collapsed-or-expanded state. */
...
/** The scrolling session tree; open groups render their complete session lists. */
function SessionTree({
  ...
  const commitSessionDrag = (activeDrag: DragState, over: NonNullable<DragState['over']>): void => {
    ...
    const renderedSessions = group.sessions
