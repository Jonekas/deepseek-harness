...
export const zh = {
  ...
  'menu.fork': '分叉会话',
  'menu.archiveSession': '搁置会话',
  'menu.restoreSession': '取消搁置',
  'menu.deleteSession': '删除会话',
  'section.settled': '已搁置',
  'delete.session.title': '删除会话',
  'delete.session.desc': '将永久删除“{name}”及其完整对话记录，以及它启动的所有子代理会话。从它分叉出的会话会保留。此操作无法在应用内撤销。',
...
export const en = {
  ...
  'menu.archiveSession': 'Settle session',
  'menu.restoreSession': 'Unsettle session',
  'menu.deleteSession': 'Delete session',
  'section.settled': 'Settled',
  'delete.session.title': 'Delete session',
  'delete.session.desc': 'This permanently deletes “{name}” and its whole conversation, along with any subagent sessions it started. Sessions forked from it are kept. This cannot be undone from the app.',
